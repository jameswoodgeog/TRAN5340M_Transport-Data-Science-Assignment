...
ggplot(y_hcare_points, aes(x = amenity, fill = amenity)) +
  geom_bar() +
  scale_fill_brewer(palette = "Set2") +
  labs(title = "Number of amenities by type", x = "Amenity", y = "Amenity count") +
