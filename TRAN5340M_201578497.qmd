...
Once the data had been prepared, 20-minute walking time isochrones were able to be calculated around each of the healthcare points. This was carried out using the `opentripplanner::otp_isochrone` function.
...
#| label: fig-oa_circuity
#| fig-cap: Mean circuity of routes to healthcare services in York
# from_to <- readRDS("Data/from_to.RDS")
